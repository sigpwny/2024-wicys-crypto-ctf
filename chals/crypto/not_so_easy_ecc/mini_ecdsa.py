...
# Challenge Note: This is an implementation of ECDSA, there are no *relevant* bugs here.
# the challenge does not rely on you understanding the code, but rather on you understanding the algorithm and the math behind it.
